...
public class Invitation extends Skill {
    ...
    public boolean usable(Combat c, Character target) {
        ...
        boolean alreadyInserted = c.getStance().havingSex(c);
        return !alreadyInserted && stanceInsertable && c.getStance().distance() < 2 && insertable && getSelf().canRespond() && getSelf().crotchAvailable() && target.crotchAvailable()
