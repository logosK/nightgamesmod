...
public class FootPump extends Skill {
    ...
    @Override public boolean resolve(Combat c, Character target) {
        ...
        target.body.pleasure(getSelf(), target.body.getRandom("feet"), target.body.getRandom("cock"), m, c, this);
        target.body.pleasure(getSelf(), target.body.getRandom("hands"), target.body.getRandom("breasts"), m2, c, this);
