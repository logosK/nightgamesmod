...
public class FlyingCowgirl extends FemdomSexStance {
    ...
    public Position reverse(Combat c) {
        if (bottom.body.getRandomWings() != null) {
            ...
            c.write(top,Global.format("Weakened by {self:possessive} squirming, {other:SUBJECT-ACTION:fall|falls} to the ground and so {self:action:do|does} {self:name-do}. Fortunately, {other:possessive} body cushions {self:possessive} fall, but you're not sure {self:action:if she appreciates that as much as you do|if you appreciate that as much as she does}. "
